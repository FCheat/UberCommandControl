...
{
    public class Descend : IRocketCommand
    {
        ...
        public string Help
        {
            get { return "Teleport down X amount of units"; }
        }

        public string Syntax
        {
            get { return "/descend <units>"; }
        }
        ...
        public void Execute(IRocketPlayer caller, string[] command)
        {
            ...
            if (!filter.Contains("."))
            {
                ...
                UnturnedChat.Say(caller, Base.Instance.Translate("descended", filter));
            }
            else
